...
import { DebounceDirective } from '../../../ui/directives/debounce.directive';
import { FormsModule } from '@angular/forms';
import { ClickOutsideDirective } from '../../../ui/directives/click-outside.directive';
...
@Component({
    ...
    standalone: true,
    imports: [ClickOutsideDirective, FormsModule, DebounceDirective, NgIf, NgFor]
})
export class ColumnFilterComponent implements OnInit {
  ...
  onSearch() {
    ...
    if(this.serverMode) {
      this.column.simpleFilter = new ColumnFilterModel(this.search, this.column, new EqualsOperator());      
